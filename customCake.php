...
<meta name="google-site-verification" content="CXuz4RmEICcUf8aFpd-lLnKSD63o37gUkIb-n4vxxgg" />
...
<div class="container">
	...
	<div class="row" >
		<!--LOGO-->  <div class="col-4" ><a href="index.html"><img src="images/try1.jpg" style="width:350px;"></a></div>
		
		<!--SEARCH BAR--> <div class="col" style="width:900px;">
								<!--	<div class="divii">
									<BR>
									<input type="text"  id="usr" name="username"  placeholder="  Search for Bakers,Bakeries Or Food ...!"  style="width:420px;height:38px;border-style:3px;border-radius:3px;">
									</div><button class="btn btn-warning" style="margin-bottom:1%;">Search </button>
									
								-->
								<script async src="https://cse.google.com/cse.js?cx=006356171535422708363:gxmbcmlp4e7"></script>
<div class="gcse-search"></div>
									</div>
								
				<div class="col-2" style="margin-top:2%;" id="userInfo"><center>	<i class="fa fa-user" aria-hidden="true"></i><a href="login.php" style="color:black;">Login</a>
							&nbsp;<a href="sign.html"> <i class="fa fa-user-plus" aria-hidden="true"></i>Sign Up!</a></center></div>
